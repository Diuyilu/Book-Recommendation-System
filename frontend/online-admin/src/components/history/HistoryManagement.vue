      ...
      <el-row>
        <el-col :span="24">
          ...
          <el-row class="book_list" :gutter="40">
            <el-col :span="3" v-for="book in tableData()" :key="book.book_id" style="margin-bottom: 20px">
...
import { getBookInfoByBorrowingAPI } from '@/apis/books'
